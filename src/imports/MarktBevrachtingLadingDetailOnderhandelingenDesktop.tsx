...
export default function MarktBevrachtingLadingDetailOnderhandelingenDesktop() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative size-full" data-name="Markt Bevrachting Lading Detail - Onderhandelingen - Desktop">
                ...
                <div className="flex flex-col items-center size-full">
                  <div className="content-stretch flex flex-col gap-[24px] items-center pb-[24px] px-[16px] relative w-full">
                    ...
                    <div className="relative rounded-[9999px] shrink-0 size-[40px]" data-name="Avatar">
                      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[9999px] size-full" src={imgMarktBevrachtingLadingDetailOnderhandelingenDesktop} />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative" data-name="Container">
          ...
          <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-px overflow-clip relative self-stretch" data-name="Modal">
            ...
            <div className="content-stretch flex items-start justify-center relative shrink-0 w-full" data-name="Container">
              <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Content">
                <div className="flex flex-col items-center size-full">
                  <div className="content-stretch flex flex-col items-center p-[24px] relative w-full">
                    ...
                    <div className="content-stretch flex isolate items-start max-w-[1116px] relative shrink-0 w-full" data-name="Content">
                            ...
                            <div className="content-stretch flex gap-[12px] items-center p-[16px] relative size-full">
                              <div className="relative rounded-[9999px] shrink-0 size-[32px]" data-name="Avatar">
                                <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[9999px]">
                                  ...
                                  <img alt="" className="absolute max-w-none object-cover rounded-[9999px] size-full" src={imgMarktBevrachtingLadingDetailOnderhandelingenDesktop} />
                                </div>
                                <div className="absolute border-[0.5px] border-[rgba(0,0,0,0.08)] border-solid inset-0 rounded-[9999px]" data-name="Contrast border" />
                              </div>
                              <div className="content-stretch flex flex-col font-['Hanken_Grotesk:Regular',sans-serif] font-normal items-start leading-[20px] relative shrink-0 text-[14px] whitespace-nowrap" data-name="Text and supporting text">
              ...
              <div className="relative self-stretch shrink-0 w-[400px]" data-name="Sidebar/Markt/Eigen lading">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-273px)] size-[20px] top-[calc(50%+167.5px)]" data-name="Cursor">
