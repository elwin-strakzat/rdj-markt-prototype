import svgPaths from "./svg-5ynll7nfuv";
...
export default function MarktEigenLadingLadingDetailOnderhandelingToevoegenEmpty() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Markt - Eigen lading - Lading detail - Onderhandeling toevoegen - Empty">
